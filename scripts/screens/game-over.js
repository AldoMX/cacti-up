class ScreenGameOver extends Screen {
  constructor(args) {
    ...
    this.addChild({
      animation: new Animation({
        sprites: [new Sprite(this.assetManager, 'game-over', { width: 475, height: 175 })]
      }),
      transition: new Transition({
    ...
    setTimeout(() => this.screenManager.changeScreen('logo'), 4000)
  }
...
screens['game-over'] = ScreenGameOver
